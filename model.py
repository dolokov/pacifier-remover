...
def create_model(inputs, targets,model=['discogan','stargan'][0]):
    
    ## discogan model 
    if model == 'discogan':
        return create_discogan_model(inputs,targets)
    elif model == 'stargan':
        return create_stargan_model(inputs,targets)
...
def create_discogan_model(inputs,targets):
